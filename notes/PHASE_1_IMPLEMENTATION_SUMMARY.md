...
- **Result:** Will be available at `https://decent.apartments/sitemap.xml`
...
- **Result:** Available at `https://decent.apartments/robots.txt`
...
- **Result:** Available at `https://decent.apartments/ai.txt`
...
- **Contains:**
  ...
  - License information
  - Technical details
- **Result:** Available at `https://decent.apartments/.well-known/ai-site.json`
...
- **Result:** Available at `https://decent.apartments/feed.xml`
...
#### 1. Verify Sitemap
Visit: `https://decent.apartments/sitemap.xml`
- Should see XML sitemap with all pages

#### 2. Verify Robots.txt
Visit: `https://decent.apartments/robots.txt`
- Should see allow rules and sitemap reference

#### 3. Test API Endpoints
```bash
# All guides
curl https://decent.apartments/api/guides.json | jq '.meta'

# Series
curl https://decent.apartments/api/series.json | jq '.meta'

# Topics
curl https://decent.apartments/api/topics.json | jq '.meta'

# Index
curl https://decent.apartments/index.json | jq '.statistics'
```

#### 4. Test AI Manifest
```bash
curl https://decent.apartments/.well-known/ai-site.json | jq '.resources'
curl https://decent.apartments/ai.txt
```

#### 5. Verify RSS Feed
Visit: `https://decent.apartments/feed.xml`
- Should see Atom/RSS feed XML

#### 6. Validate Structured Data
**Using Google Rich Results Test:**
1. Go to: https://search.google.com/test/rich-results
2. Enter any guide URL (e.g., `https://decent.apartments/guides/how-chatgpt-works-a-simple-explanation/`)
